...
const services: Service[] = [
  ...
  {
    title: "Nhuộm Davines cao cấp",
    image:
      "https://storage.30shine.com/web/v4/images/dich-vu-nhuom/chi-tiet/quy_trinh_2.jpg",
  },
  {
    title: "Xả Tóc",
    image:
