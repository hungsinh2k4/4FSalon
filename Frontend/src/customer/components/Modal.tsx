...
const Modal = (props: PopupProps) => {
    ...
    return (
        <div className={`absolute inset-0 bg-opacity-25 backdrop-blur-[1px] flex items-center justify-center`}>
            <div className="flex bg-white p-6 border border-solid rounded-xl justify-center gap-2 shadow-lg">
                <div className="p-2 bg-red-100 h-fit w-fit rounded-full items-center justify-center">
                    <svg width="24px" height="24px" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="currentColor" className="text-red-400"
                    >
                ...
                <div>
                    <h4 className="text-2xl font-semibold text-gray-800">{props.title}</h4>
