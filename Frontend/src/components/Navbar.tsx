    ...
    <nav className="bg-white p-4 sticky top-0 left-0 shadow-md z-10">
      <div className="container mx-auto flex justify-between ">
        ...
        <div className="hidden md:flex items-center ">
          <Link to="/" className="nav-items">Trang Chủ</Link>
          <Link to="/aboutUs" className="nav-items">Về chúng tôi</Link>
          <Link to="/contact" className="nav-items">Liên hệ</Link>
          <Link to="/findNearestShop" className="nav-items">Tìm chi nhánh</Link>
          <Link to="/booking" className="nav-items">Đặt lịch Hẹn</Link>
          <Link to="/login" className="bg-black ml-16 py-1  text-white px-3 rounded-full hover:bg-gray-600 hover:text-white transition-colors duration-200">Đăng Nhập</Link>
        </div>
